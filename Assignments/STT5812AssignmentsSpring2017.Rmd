...
* Follow the directions from [Happy Git and GitHub for the useR](https://http://happygitwithr.com/) to [Introduce yourself to Git](http://happygitwithr.com/hello-git.html), [Connect to GitHub](http://happygitwithr.com/push-pull-github.html), and [Cache credentials for HTTPS](http://happygitwithr.com/credential-caching.html).
...
5. Type a name (suggestion `UserNameSTT5812`) in the `Project directory name:` box.
...
* Commit your final changes for Project 1 to your private repository and email the instructor your SHA prior to 10am March 22, 2016.  Use the subject line "Project 1-STT3851-Last_name First_name-SHA#" in your email.
...
* Make sure a single `.Rmd` with the sections outlined in the [Example Paper](../../STT3851ClassRepo/BDbetaTemplate/TemplateBookDown.html) is in your `Project2` directory under your private course repository.  This is 10% of the assignment grade.
